...
- Live projectile-rate, sphere-speed, and recoil-pattern tuning controls with keyboard-editable numeric inputs
...
- a controller settings panel for sensitivity, deadzone, FOV, projectile rate, sphere speed, recoil pattern, invert-Y, and response curves
